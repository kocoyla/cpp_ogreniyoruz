...
```
Bunlarla biraz daha alıştırma yapmak isterseniz, [buradaki kodu](https://onlinegdb.com/_CroqvtI4r) çatallayıp birden yüze kadar bütün sayıların çarpanlarını bu *eşlem2* içine ekleyin. Tabii elle değil, daha önce yazdığımız çarpan bulma kodunu ekleyerek 😉.
