...
Derste beraber yazdığımız yeni `Temel` adlı türün (`class`) [kodu burada]( https://www.onlinegdb.com/IO4hMr9R-). Biraz düzeltmeler yapılmış hali de [burada]( https://onlinegdb.com/8h299NKAP). Bilhassa `cout` yerine `dout` nesnesine ve bakın.  
